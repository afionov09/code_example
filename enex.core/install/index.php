...
class enex_core extends CModule
{
    /**
     * @var string
     */
    public $MODULE_ID = 'enex.core';
    ...
    {
        $this->MODULE_NAME = Loc::getMessage('ENEX_CORE_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('ENEX_CORE_MODULE_DESCRIPTION');
